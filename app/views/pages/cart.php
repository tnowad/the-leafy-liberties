                ...
                <div class="flex items-center justify-between item-detail">
                  ...
                  <div class="w-[150px]">
                    <form class="flex items-center justify-center mx-auto product-quantity w-fit h-fit">
                      ...
                      <input type="number" name="quantity" class="w-10 text-lg text-center text-count" value="<?php echo $cartItem->quantity; ?>" onkeydown="if (event.keyCode === 69 || event.keyCode === 189 || event.keyCode == 107 || event.keyCode == 110 || event.keyCode == 109 || event.keyCode == 190) return false;" />
