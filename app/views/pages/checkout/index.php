...
<div class="flex items-center justify-center w-full mt-10">
  <form action="<?php echo BASE_URI . '/checkout/confirm' ?>" method="POST" action class="container flex flex-wrap xl:flex-nowrap">
      ...
      <div class="w-full p-5 mt-5 border-0 shadow-lg shipping-container rounded-2xl shadow-gray-300 ">
        ...
        <div class="flex flex-col justify-between gap-5 px-5 choice">
          <?php foreach ($shippingMethods as $shippingMethod) : ?>
            <div class="shipping-choices border-[1px] border-gray-500 p-3 border-solid rounded-lg flex items-center justify-start cursor-pointer" onclick="document.getElementById('shipping-method-<?php echo $shippingMethod->id ?>').checked = true;">
              <input type="radio" name="shipping-method-id" required id="shipping-method-<?php echo $shippingMethod->id ?>" value="<?php echo $shippingMethod->id ?>" class="accent-[#315854]" />
      ...
      <div class="w-full p-5 mt-5 mb-10 border-0 shadow-lg payment-container rounded-2xl shadow-gray-300">
        ...
        <div class="flex flex-col justify-between gap-5 px-5 choice">
          ...
          <div class="payment-choice border-[1px] border-gray-500 p-3 border-solid rounded-lg flex items-center justify-start cursor-pointer" for="credit">
            <input type="radio" name="payment-method-type" id="credit" required class="accent-[#315854]" value="credit" />
        ...
        <div class="body-summary">
          ...
          <div class="mt-5 bottom-summary">
            ...
            <fieldset class="border-[1px] border-gray-600 border-solid rounded-md p-1 mr-10 w-full h-auto mt-4">
              ...
              <textarea type="text" name="description" placeholder="Type here..." rows="7" class="w-full p-1 text-lg focus:outline-none focus:border-0"></textarea>
            </fieldset>
