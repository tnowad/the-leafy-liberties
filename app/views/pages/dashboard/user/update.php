...
<div class="w-full ">
  <div class="bg-white rounded-md shadow-lg w-full p-5 m-5 h-full">
    <form class="flex flex-col" action="<?php echo BASE_URI . '/dashboard/user/update' ?>" method="POST">
      ...
      <input type="text" value="<?php echo $user->id ?>" name="id"
        class="bg-gray-100 p-3 focus:outline-none rounded-lg"disabled />
      ...
      <input type="password" value="<?php echo $user->password ?>" name="email"
        class="bg-gray-100 p-3 focus:outline-none rounded-lg" />
