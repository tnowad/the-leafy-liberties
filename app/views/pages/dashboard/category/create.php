<div class="add-form min-h-screen w-full justify-center items-center">
  <div class="bg-white p-8 rounded-md shadow-lg ">
    <h2 class="mb-4 text-xl font-bold">Add Category</h2>
    <form class="flex flex-col" action="<?php BASE_URI . "/dashboard/category/create"; ?>" method="POST" enctype="multipart/form-data">
      ...
      <a href="<?php echo BASE_URI . '/dashboard/category' ?>"
        class="text-center px-4 py-2 my-1 font-bold text-white bg-gray-500 rounded cancel-button hover:bg-gray-700">
        Cancel
      </a>
    </form>
  </div>
