      ...
      <div class="overflow-hidden relative h-56 rounded-lg sm:h-64 xl:h-80 2xl:h-96">
        ...
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
          <span class="absolute top-1/2 left-1/2 text-2xl font-semibold text-white -translate-x-1/2 -translate-y-1/2 sm:text-3xl ">Primer
            Slide</span>
          <img src="../assets/img/mainHomeImg.png" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
        </div>
        ...
        for ($i = 1; $i <= $total; $i++) { ?>
          <div class="genres-detail relative overflow-hidden rounded-3xl cursor-pointer mr-2 w-fit">
            <div class="img overflow-hidden w-full h-56 rounded-3xl">
              <img src="../assets/img/genresHorror.png" alt="" class="rounded-3xl hover:scale-125 transition-transform w-full h-full object-cover" />
            </div>
