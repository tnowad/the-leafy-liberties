<header class="flex justify-center w-full sticky top-0 bg-white z-10 border-0 border-solid border-gray-200 border-b-[1px]">
  <div class="mt-5 h-24 container flex justify-between items-center">
    ...
    <div class="w-full box-border px-10">
      <form onSubmit="" class="flex items-center justify-center w-full h-10 bg-gray-100 rounded-full">
        <input type="text" name="searchQuery"
          class="pl-5 w-full h-full bg-transparent rounded-tl-full rounded-bl-full" placeholder="Search.... "/>
    ...
    <div class="flex-row justify-between hidden md:flex gap-2">
      <button type="button" class="border-[1px] border-solid px-3 py-2 rounded-xl hover:bg-[#6cada6] transition-all hover:text-white w-10">
        <i class="fa-regular fa-user"></i>
      </button>
      <button type="button" class="border-[1px] border-solid px-3 py-2 rounded-xl hover:bg-[#6cada6] transition-all hover:text-white w-10">
        <i class="fa-regular fa-heart"></i>
      </button>
      <button type="button" class="border-[1px] border-solid px-2 py-2 rounded-xl hover:bg-[#6cada6] transition-all hover:text-white w-10">
