...
<footer
  ...
  <div class="container sm:grid sm:m-auto lg:flex">
    <div
      ...
      <div class="sm:justify-center sm:items-center lg:flex lg:justify-start">
        <div class="flex items-center justify-center mr-3">
          <img src="<?php echo BASE_URI . '/resources/images/BigLogo.png' ?>" alt="FooterLogo" />
        </div>
    ...
    <div class="grid justify-center grid-cols-2 text-center right-container sm:grid-cols-4 sm:w-full sm:mt-7 lg:w-3/4">
      <div class="explore">
