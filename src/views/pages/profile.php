        ...
        <div class=" mt-5 md:mt-20 flex flex-col md:flex-row border border-b-2 border-gray-300 box-border w-full">
            ...
            <div class="p-2 w-full md:w-3/4">
                <form class="flex flex-col">
                    ...
                    <div class="flex flex-row justify-between">
                        <div class="w-4/12 flex flex-col">
                            ...
                            <input type="text" required
                                class="h-9 p-5 w-full border border-solid border-gray-300 rounded-md" />
                        </div>
                        <div class="w-4/12 flex flex-col">
                    ...
                    <input type="tel" class="h-9 p-5 w-full border border-solid border-gray-300 rounded-md" name="phone"
                        placeholder="+84XXXXXXXXX" pattern="^(\+84|0)(1\d{9}|3\d{8}|5\d{8}|7\d{8}|8\d{8}|9\d{8})$"
                        required></input>
                    <label>Gender *</label>
                    <div class="flex justify-around w-3/4 md:w-3/5">
                        <input type="radio" name="gender" value="Male"
                            class="h-5 w-6 inline-block border border-solid border-gray-300 rounded-md" />
                    ...
                    <div class="h-8 md:h-10 w-full md:w-2/4 flex justify-between">
                        <input type="number" min="1" max="31"
                            class="p-1 pl-6  text-base md:text-2xl border border-solid border-gray-300 rounded" />
                    ...
                    <input type="submit" value="Save changes"
                        class="p-2 mt-5 w-3/6 sm:w-1/6 text-white cursor-pointer bg-teal-800 border  rounded-2xl" />
                </form>
            </div>
        </div>
    </div>
