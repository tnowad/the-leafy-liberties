<div className="flex justify-center w-full flex-col items-center">
    ...
    <div className="container">
        ...
        <div className="flex">
            ...
            <div className="hidden w-[25%] xl:block 2xl:w-1/3">
                <div className="w-full h-auto sticky top-32">
                    <img src={bestOffer} alt="" className="rounded-2xl h-full w-full" />
        ...
        <div className="flex mb-5 lg:gap-0 sm:gap-3 lg:flex-row mobile:flex-col">
            <div
                className="lg:w-1/4 bg-orange-50 lg:p-5 rounded-2xl xl:mr-10 lg:mr-2 mobile:w-full md:p-2 overflow-hidden lg:overflow-x-hidden">
                <div
                    className="header-table lg:text-2xl border-0 border-solid border-b-2 mb-6 p-3 whitespace-nowrap md:text-xl mobile:text-center">
                    <p>Popular Author</p>
                </div>
            ...
            <div className="author-bestselling lg:w-3/4 mobile:w-full">
                ...
                <div className="list-author-bestselling">
                    <div className=" h-fit top-product flex sm:w-full mobile:w-screen sm:gap-0 mobile:gap-2 sm:m-0">
                        ...
                        <div
                            className="top-product-detail flex flex-col xl:justify-between sm:gap-0 lg:justify-start mobile:w-fit">
                            ...
                            <div
                                className="top-product-desc text-ellipsis sm:w-full sm:pr-20 inline mobile:text-sm mobile:w-3/4 mobile:h-fit">
