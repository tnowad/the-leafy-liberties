    ...
    <div
      ...
      <div class="sm:justify-center sm:items-center lg:flex lg:justify-start">
        <div class="flex justify-center items-center mr-3">
          <img src="../asset/img/bigLogo.png" alt="logo">
        </div>
        <div class="flex-col justify-center lg:flex hidden">
      ...
      <div class="description">
        <p class="text-base mt-3 p-3 font-normal sm:text-center lg:text-left">The LeafLiberty is a Book
          Store
          E-commerce Website Designed by Tuan, Phat, Chinh, Bao</p>
      </div>
      <div class="w-full h-12 my-6 pl-3">
        <div class="flex justify-evenly">
          <i class="fa-brands fa-facebook-f text-4xl hover:text-blue-500 transition-all cursor-pointer"></i>
          <i class="fa-brands fa-youtube text-4xl hover:text-red-500 transition-all cursor-pointer"></i>
          <i class="fa-brands fa-instagram text-4xl hover:text-pink-500 transition-all cursor-pointer"></i>
          <i class="fa-brands fa-twitter text-4xl hover:text-blue-600 transition-all cursor-pointer"></i>
        </div>
      </div>
    </div>
    <div class="right-container grid grid-cols-2 sm:grid-cols-4 justify-center text-center sm:w-full sm:mt-7 lg:w-3/4">
      <div class="explore">
        <button class="text-xl font-medium mb-2">Explore
