...
const handlePageNumber = async (number, products) => {
    ...
    for (let i = 0; i < liElements.length; i++) {
        ...
        if ((currentPage == 1 && i == 0) || (currentPage + 2 == liElements.length && i + 1 == liElements.length))
            liElements[i].classList.add("hidden")
        else liElements[i].classList.remove("hidden")
        // if (currentPage + 2 == liElements.length  && i+1  == liElements.length) liElements[i].class.add("hidden")
        // else liElements[i].classList.remove("hidden")
    }
...
const handlePrevPage = (i, products) => {
    console.log("Prev")
}
const handleNextPage = (i, products) => {
    console.log("Next")
}
