$(document).ready(function () {
  $(".bestselling-products").slick({
    ...
    autoplaySpeed: 4000,
    infinite: true,
    prevArrow: `<button type="button" class="slick-prev pull-left absolute top-1/2 z-[100] ">
      <i class="fa-solid fa-chevron-left bg-gray-300 p-3 w-10 h-10 text-white rounded-full hover:bg-primary-600 transition-all"></i>
      </button>`,
      nextArrow: `<button type="button" class="slick-prev pull-right absolute top-1/2 z-[100] right-0 ">
